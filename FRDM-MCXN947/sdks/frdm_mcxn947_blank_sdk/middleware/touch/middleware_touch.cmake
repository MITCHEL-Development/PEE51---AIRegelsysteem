# Add set(CONFIG_USE_middleware_touch true) in config.cmake to use this component
...
message("${CMAKE_CURRENT_LIST_FILE} component is included.")
      ...
      target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
          ...
          ${CMAKE_CURRENT_LIST_DIR}/source/keydetectors/nt_keydetector_mbw.c
          ...
          ${CMAKE_CURRENT_LIST_DIR}/source/xtalk/nt_xtalk.c
        )
      ...
      target_include_directories(${MCUX_SDK_PROJECT_NAME} PUBLIC
          ...
          ${CMAKE_CURRENT_LIST_DIR}/source/xtalk
