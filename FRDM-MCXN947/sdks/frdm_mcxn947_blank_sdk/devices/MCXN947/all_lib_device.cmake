...
#  # description: mflash onchip_fmu
#  set(CONFIG_USE_component_mflash_onchip_fmu true)
...
#  # description: NPX Driver
#  set(CONFIG_USE_driver_npx true)
...
#  # description: TFM CMSIS Flash IAP MCXN driver
#  set(CONFIG_USE_middleware_tfm_flash_mcxn true)

#  # description: TFM CMSIS Flash K4 driver
#  set(CONFIG_USE_middleware_tfm_flash_k4_romapi true)
...
#  # description: MQTT standalone sources for nxp_iot_agent
#  set(CONFIG_USE_middleware_nxp_iot_agent_mqtt true)
...
#  # description: RPMsg-Lite for mcxnx10 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_mcxnx4x true)
...
#  # description: mbedTLS port library for ELS PKC
...
#  # description: MCX ethernet interface non_generated_lwipopts
#  set(CONFIG_USE_middleware_lwip_mcx_ethernetif_non_generated_lwipopts true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmmcxn947/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/mcxn9xxevk/project_template
...
include_if_use(board_project_template)
include_if_use(component_ak4497_adapter.MCXN947)
include_if_use(component_at_least_one_i2c_mux_device_enabled.MCXN947)
...
include_if_use(component_cs42448_adapter.MCXN947)
...
include_if_use(component_enable_pca9544.MCXN947)
include_if_use(component_enable_pca9548.MCXN947)
include_if_use(component_eth_phy_common.MCXN947)
include_if_use(component_flash_adapter.MCXN947)
include_if_use(component_flash_nand_flexspi.MCXN947)
include_if_use(component_flash_nor_flexspi.MCXN947)
include_if_use(component_gpio_adapter.MCXN947)
include_if_use(component_i2c_adapter_interface.MCXN947)
include_if_use(component_i2c_mux_pca954x.MCXN947)
...
include_if_use(component_log_backend_debug_console.MCXN947)
include_if_use(component_log_backend_debug_console_lite.MCXN947)
...
include_if_use(component_mcxw_flash_adapter.MCXN947)
include_if_use(component_mem_manager.MCXN947)
include_if_use(component_mem_manager_freertos.MCXN947)
include_if_use(component_mem_manager_legacy.MCXN947)
include_if_use(component_mem_manager_light.MCXN947)
include_if_use(component_mflash_offchip.MCXN947)
include_if_use(component_mflash_onchip.MCXN947)
include_if_use(component_mflash_onchip_fmu.MCXN947)
...
include_if_use(component_pcm186x_adapter.MCXN947)
include_if_use(component_pcm512x_adapter.MCXN947)
include_if_use(component_phyaqr113c.MCXN947)
include_if_use(component_phyar8031.MCXN947)
include_if_use(component_phydp8384x.MCXN947)
include_if_use(component_phyksz8041.MCXN947)
include_if_use(component_phyksz8081.MCXN947)
include_if_use(component_phylan8720a.MCXN947)
include_if_use(component_phylan8741.MCXN947)
include_if_use(component_phyrtl8201.MCXN947)
include_if_use(component_phyrtl8211f.MCXN947)
include_if_use(component_phyvsc8541.MCXN947)
include_if_use(component_power_manager_framework.MCXN947)
...
include_if_use(component_silicon_id_imx8.MCXN947)
include_if_use(component_silicon_id_imx93.MCXN947)
include_if_use(component_silicon_id_imxrt10xx.MCXN947)
include_if_use(component_silicon_id_imxrt1170.MCXN947)
include_if_use(component_silicon_id_imxrt1180.MCXN947)
include_if_use(component_silicon_id_rw610.MCXN947)
include_if_use(component_silicon_id_scfw.MCXN947)
include_if_use(component_software_crc_adapter.MCXN947)
include_if_use(component_software_rng_adapter.MCXN947)
include_if_use(component_tfa9896_adapter.MCXN947)
include_if_use(component_tfa9xxx_adapter.MCXN947)
include_if_use(component_timer_manager.MCXN947)
include_if_use(component_wifi_bt_module_88W8801.MCXN947)
include_if_use(component_wifi_bt_module_88W8987.MCXN947)
include_if_use(component_wifi_bt_module_IW416.MCXN947)
include_if_use(component_wifi_bt_module_IW61X.MCXN947)
include_if_use(component_wifi_bt_module_RW61X.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_am457_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_am457ma.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_am510_arduino.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_am510_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_am510ma.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_cm358_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_cm358ma.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_nm191_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_aw_nm191ma.MCXN947)
include_if_use(component_wifi_bt_module_board_frdm_rw61x.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_1xk_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_1xk_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_1zm_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_1zm_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2dl_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2dl_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2ds_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2ds_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2el_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2el_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_murata_2ll_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_rd_rw61x.MCXN947)
include_if_use(component_wifi_bt_module_board_ubx_jody_w2_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_m2.MCXN947)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_ubx_lily_w1_usd.MCXN947)
include_if_use(component_wifi_bt_module_board_ubx_maya_w1_usd.MCXN947)
include_if_use(component_wifi_bt_module_config.MCXN947)
include_if_use(component_wifi_bt_module_tx_pwr_limits.MCXN947)
include_if_use(component_wm8524_adapter.MCXN947)
include_if_use(component_wm8904_adapter.MCXN947)
include_if_use(component_wm8960_adapter.MCXN947)
include_if_use(component_wm8962_adapter.MCXN947)
include_if_use(device_CMSIS.MCXN947)
include_if_use(device_RTE.MCXN947)
include_if_use(device_project_template.MCXN947)
include_if_use(device_startup.MCXN947)
include_if_use(device_system.MCXN947)
include_if_use(driver_ak4497.MCXN947)
include_if_use(driver_cache_cache64.MCXN947)
include_if_use(driver_cache_lpcac_n4a_mcxn.MCXN947)
include_if_use(driver_camera-common.MCXN947)
include_if_use(driver_camera-device-common.MCXN947)
include_if_use(driver_camera-device-ov5640.MCXN947)
include_if_use(driver_camera-device-ov7670.MCXN947)
include_if_use(driver_camera-device-ov7725.MCXN947)
...
include_if_use(driver_cmsis_gpio.MCXN947)
...
include_if_use(driver_cs42448.MCXN947)
...
include_if_use(driver_flexspi_edma.MCXN947)
include_if_use(driver_ft3267.MCXN947)
include_if_use(driver_ft5406.MCXN947)
include_if_use(driver_ft5406_rt.MCXN947)
include_if_use(driver_ft6x06.MCXN947)
include_if_use(driver_fxas21002cq.MCXN947)
include_if_use(driver_fxls8974cf.MCXN947)
...
include_if_use(driver_htu21d.MCXN947)
include_if_use(driver_i3c.MCXN947)
include_if_use(driver_i3c_edma.MCXN947)
include_if_use(driver_icm42688p.MCXN947)
...
include_if_use(driver_lpflexcomm_lpi2c.MCXN947)
include_if_use(driver_lpflexcomm_lpi2c_edma.MCXN947)
include_if_use(driver_lpflexcomm_lpi2c_freertos.MCXN947)
include_if_use(driver_lpflexcomm_lpspi.MCXN947)
include_if_use(driver_lpflexcomm_lpspi_edma.MCXN947)
include_if_use(driver_lpflexcomm_lpspi_freertos.MCXN947)
include_if_use(driver_lpflexcomm_lpuart.MCXN947)
include_if_use(driver_lpflexcomm_lpuart_edma.MCXN947)
include_if_use(driver_lpflexcomm_lpuart_freertos.MCXN947)
include_if_use(driver_lptmr.MCXN947)
include_if_use(driver_lsm6dso.MCXN947)
include_if_use(driver_mailbox.MCXN947)
include_if_use(driver_max30101.MCXN947)
...
include_if_use(driver_npx.MCXN947)
include_if_use(driver_opamp.MCXN947)
include_if_use(driver_ostimer.MCXN947)
include_if_use(driver_otp.MCXN947)
include_if_use(driver_p3t1755.MCXN947)
include_if_use(driver_pcm186x.MCXN947)
include_if_use(driver_pcm512x.MCXN947)
...
include_if_use(driver_pf5020.MCXN947)
...
include_if_use(driver_psp27801.MCXN947)
include_if_use(driver_puf_v3.MCXN947)
include_if_use(driver_pwm.MCXN947)
include_if_use(driver_qdc.MCXN947)
include_if_use(driver_reset.MCXN947)
include_if_use(driver_romapi.MCXN947)
include_if_use(driver_romapi_flashiap.MCXN947)
include_if_use(driver_romapi_nboot.MCXN947)
...
include_if_use(driver_sema42.MCXN947)
...
include_if_use(driver_smartcard_phy_gpio.MCXN947)
include_if_use(driver_smartcard_phy_tda8035.MCXN947)
include_if_use(driver_smartcard_uart.MCXN947)
include_if_use(driver_smartdma.MCXN947)
...
include_if_use(driver_tfa9896.MCXN947)
include_if_use(driver_tfa9xxx.MCXN947)
include_if_use(driver_tfa9xxx_hal.MCXN947)
include_if_use(driver_tma525b.MCXN947)
include_if_use(driver_trdc_1.MCXN947)
include_if_use(driver_trdc_soc.MCXN947)
include_if_use(driver_tsi_v6.MCXN947)
include_if_use(driver_tsl2561.MCXN947)
...
include_if_use(driver_wm8524.MCXN947)
include_if_use(driver_wm8904.MCXN947)
include_if_use(driver_wm8960.MCXN947)
include_if_use(driver_wm8962.MCXN947)
...
include_if_use(middleware_lwip_mcx_ethernetif_non_generated_lwipopts)
...
include_if_use(middleware_mbedtls_port_els_pkc_option)
...
include_if_use(middleware_motor_control_mc_drivers_adcncxn_pwma_qdc)
...
include_if_use(middleware_multicore_rpmsg-lite_mcxnx4x)
...
include_if_use(middleware_nxp_iot_agent_mqtt)
...
include_if_use(middleware_tfm_flash_k4_romapi)
include_if_use(middleware_tfm_flash_mcxn)
...
include_if_use(utility_debug_console_template_config.MCXN947)
