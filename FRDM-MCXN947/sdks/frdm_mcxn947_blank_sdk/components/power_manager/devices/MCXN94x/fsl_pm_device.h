...
#define PM_MASK_RESC_RAMA                                                                         \
    ((1UL << kResc_SRAM_RAMA0_8K) | (1UL << kResc_SRAM_RAMA1_8K) | (1UL << kResc_SRAM_RAMA2_8K) | \
     (1UL << kResc_SRAM_RAMA3_8K))

#define PM_MASK_RESC_RAMS                                                                                          \
    ((1UL << kResc_SRAM_RAMX0_32K) | (1UL << kResc_SRAM_RAMX1_32K) | (1UL << kResc_SRAM_RAMX2_32K) |               \
     (1UL << kResc_SRAM_RAMB0_32K) | (1UL << kResc_SRAM_RAMC0_32K) | (1UL << kResc_SRAM_RAMC1_32K) |               \
     (1UL << kResc_SRAM_RAMD0_32K) | (1UL << kResc_SRAM_RAMD1_32K) | (1UL << kResc_SRAM_RAME0_32K) |               \
     (1UL << kResc_SRAM_RAME1_32K) | (1UL << kResc_SRAM_RAMF0_32K) | (1UL << kResc_SRAM_RAMF1_32K) |               \
     (1UL << kResc_SRAM_RAMG01_32K) | (1UL << kResc_SRAM_RAMG23_32K) | (1UL << kResc_SRAM_RAMH01_32K) |            \
     (1UL << kResc_SRAM_LPCAC) | (1UL << kResc_SRAM_DMA_PKC) | (1UL << kResc_SRAM_USB0) | (1UL << kResc_SRAM_PQ) | \
     (1UL << kResc_SRAM_CAN_ENET_USB1) | (1UL << kResc_SRAM_FLEXSPI0) | PM_MASK_RESC_RAMA)

/* VBAT */
#define PM_MASK_RESC_LOWEST_VBAT0 PM_MASK_RESC_RAMA
#define PM_MASK_RESC_LOWEST_VBAT1 \
    ((1UL << (kResc_FRO_16K - 32)) | (1UL << (kResc_OSC_RTC - 32)) | (1UL << (kResc_BG_VBAT - 32)))

/* Deep power down */
#define PM_MASK_RESC_LOWEST_DPD0 ((1UL << kResc_LDO_SYS) | PM_MASK_RESC_LOWEST_VBAT0)
#define PM_MASK_RESC_LOWEST_DPD1                                                               \
    ((1UL << (kResc_CMP0 - 32)) | (1UL << (kResc_CMP1 - 32)) | (1UL << (kResc_HVD_SYS - 32)) | \
     (1UL << (kResc_LVD_SYS - 32)) | PM_MASK_RESC_LOWEST_VBAT1)

/* Power down */
#define PM_MASK_RESC_LOWEST_PDPD0 \
    ((1UL << kResc_DCDC_CORE) | (1UL << kResc_LDO_CORE) | PM_MASK_RESC_RAMS | PM_MASK_RESC_LOWEST_DPD0)
#define PM_MASK_RESC_LOWEST_PDPD1                                                                     \
    ((1UL << (kResc_USB3V_DET - 32)) | (1UL << (kResc_BG_CORE - 32)) | (1UL << (kResc_GDET - 32)) |   \
     (1UL << (kResc_HVD_CORE - 32)) | (1UL << (kResc_LVD_CORE - 32)) | (1UL << (kResc_HVD_IO - 32)) | \
     (1UL << (kResc_LVD_IO - 32)) | (1UL << (kResc_IO_Det - 32)) | PM_MASK_RESC_LOWEST_DPD1)

/* Power down and deep sleep */
#define PM_MASK_RESC_LOWEST_PDDS0 ((1UL << kResc_CORE_WAKE) | PM_MASK_RESC_LOWEST_PDPD0)
#define PM_MASK_RESC_LOWEST_PDDS1 \
    ((1UL << (kResc_FRO_12M - 32)) | (1UL << (kResc_CMP2 - 32)) | PM_MASK_RESC_LOWEST_PDPD1)

/* Deep sleep */
#define PM_MASK_RESC_LOWEST_DEEP_SLEEP0 ((1UL << kResc_Flash) | PM_MASK_RESC_LOWEST_PDDS0)
#define PM_MASK_RESC_LOWEST_DEEP_SLEEP1                                                           \
    ((1UL << (kResc_DAC0 - 32)) | (1UL << (kResc_DAC1 - 32)) | (1UL << (kResc_DAC2 - 32)) |       \
     (1UL << (kResc_OPAMP0 - 32)) | (1UL << (kResc_OPAMP1 - 32)) | (1UL << (kResc_OPAMP2 - 32)) | \
     (1UL << (kResc_VREF - 32)) | (1UL << (kResc_SINC - 32)) | PM_MASK_RESC_LOWEST_PDDS1)

/* Sleep */
#define PM_MASK_RESC_LOWEST_SLEEP0 ((1UL << kResc_FRO_144M) | PM_MASK_RESC_LOWEST_DEEP_SLEEP0)
#define PM_MASK_RESC_LOWEST_SLEEP1                                                             \
    ((1UL << (kResc_PLL0 - 32)) | (1UL << (kResc_PLL1 - 32)) | (1UL << (kResc_OSC_SYS - 32)) | \
     (1UL << (kResc_ADC - 32)) | PM_MASK_RESC_LOWEST_DEEP_SLEEP1)

/* Resource constraints that are not variable, set by the power mode*/
#define PM_MASK_RESC_NOT_VAR0 ~((1UL << kResc_BUS_SYS_Clk) & (1UL << kResc_CORE_WAKE))
