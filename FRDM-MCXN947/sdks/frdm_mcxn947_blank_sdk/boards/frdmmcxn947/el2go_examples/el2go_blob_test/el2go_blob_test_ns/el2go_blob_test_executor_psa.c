...
static psa_status_t perform_aead_decrypt(psa_key_id_t id, psa_key_type_t key_type, psa_algorithm_t key_alg, struct test_result_t *result)
{
    ...
    const uint8_t ciphertext[]        = {0xFA, 0xBF, 0x93, 0x49, 0xE7, 0x24, 0xA5, 0x33, 0x4B, 0xC0,
                                         0xBF, 0x01, 0x17, 0xAF, 0x04, 0x3D, 0xC0, 0xC9, 0xDE, 0x51,
                                         0xD9, 0xC7, 0xA5, 0x96, 0xB1, 0x36, 0x17, 0xD4, 0xF7, 0x0A,
                                         0xFB, 0xA5, 0xED, 0x83, 0x08, 0xC1, 0xB2, 0x1D, 0x19, 0x27};
