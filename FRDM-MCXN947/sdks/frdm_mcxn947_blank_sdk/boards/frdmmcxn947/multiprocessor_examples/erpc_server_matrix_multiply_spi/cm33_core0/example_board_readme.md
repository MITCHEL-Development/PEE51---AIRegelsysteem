...
Board settings
==============
Populate R136, R137, R138, R139, R142, R143
...
Running the demo
================
When the target device application is running execute Python run_spi.py from boards\frdmmcxn947\multiprocessor_examples\erpc_common\erpc_matrix_multiply folder:
