...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio0_pinB12_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_10 (pin B12)  */
    GPIO_PinInit(GPIO0, 10U, &gpio0_pinB12_config);

    gpio_pin_config_t gpio0_pinE10_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_27 (pin E10)  */
    GPIO_PinInit(GPIO0, 27U, &gpio0_pinE10_config);
    ...
    GPIO_PinInit(GPIO1, 2U, &gpio1_pinC4_config);
