...
const struct nt_electrode *const Keypad_1_controls[]         = {&El_1, &El_2, &El_3, &El_4, &El_5, NULL};
const struct nt_electrode *const ASlider_2_controls[]        = {&El_6, &El_7, NULL};
const struct nt_electrode *const ARotary_3_controls[]        = {&El_8, &El_9, &El_10, &El_11, NULL};
...
const struct nt_control_keypad nt_control_keypad_Keypad_1 = {
    .groups           = NULL,
    .groups_size      = 0,
    .multi_touch      = (uint32_t[]){0x0C, 0x18, 0x14},
    .multi_touch_size = 3,
};
...
const struct nt_electrode *const nt_tsi_module_electrodes_1[] = {&El_1,
                                                                 &El_2, &El_3,  &El_4, &El_5, 
                                                                 &El_6, &El_7,
																 &El_8, &El_9, &El_10, &El_11, NULL};
