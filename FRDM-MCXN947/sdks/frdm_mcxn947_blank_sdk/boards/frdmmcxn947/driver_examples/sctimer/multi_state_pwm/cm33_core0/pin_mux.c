...
- pin_list:
  ...
  - {pin_num: B4, peripheral: SCT0, signal: 'IN, 1', pin_signal: PIO1_3/WUU0_IN7/TRIG_OUT1/FC3_P3/CT1_MAT1/SCT0_IN7/FLEXIO0_D11/ENET0_MDIO/SAI1_RXD0/CAN0_RXD/TSI0_CH3/ADC0_A19/CMP0_IN1,
...
void BOARD_InitPins(void)
{
    ...
    /* SCT0_IN7 is selected as trigger input for SCT channel 1 */
    INPUTMUX_AttachSignal(INPUTMUX0, 1U, kINPUTMUX_Sct0In7ToSct0);
    ...
    const port_pin_config_t port1_3_pinB4_config = {/* Internal pull-up resistor is enabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT1_3 (pin B4) is configured as SCT0_IN7 */
