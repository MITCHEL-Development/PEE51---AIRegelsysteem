...
- pin_list:
  ...
  - {pin_num: F10, peripheral: LP_FLEXCOMM1, signal: LPFLEXCOMM_P2, pin_signal: PIO0_26/FC1_P2/CT0_MAT2/ADC0_B18, slew_rate: slow, open_drain: disable, drive_strength: low,
    pull_select: up, pull_enable: enable, input_buffer: enable, invert_input: normal}
  - {pin_num: B7, peripheral: LP_FLEXCOMM1, signal: LPFLEXCOMM_P3, pin_signal: PIO0_23/WUU0_IN5/EWM0_OUT_b/FC1_P3/CT_INP3/FLEXIO0_D7/ADC0_A15/CMP2_IN2, pull_select: up,
...
void BOARD_InitSincPins(void)
{
    ...
    /* PORT4_12 (pin T6) is configured as SINC0_MCLK0 */
    PORT_SetPinMux(PORT4, 12U, kPORT_MuxAlt9);

    PORT4->PCR[12] =
        ((PORT4->PCR[12] &
          /* Mask bits to zero which are setting */
          (~(PORT_PCR_PS_MASK | PORT_PCR_PE_MASK | PORT_PCR_SRE_MASK | PORT_PCR_ODE_MASK | PORT_PCR_IBE_MASK | PORT_PCR_INV_MASK)))
    ...
    /* PORT4_13 (pin T7) is configured as SINC0_MBIT0 */
    PORT_SetPinMux(PORT4, 13U, kPORT_MuxAlt9);
    ...
    /* PORT4_15 (pin T8) is configured as SINC0_MCLK_OUT0 */
    PORT_SetPinMux(PORT4, 15U, kPORT_MuxAlt9);
